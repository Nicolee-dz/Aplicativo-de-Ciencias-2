...
class TriesController {
    ...
    init() {
        console.log('TriesController inicializado');
    }
    ...
    _showSearchInfo(char, result) {
        const info = document.getElementById('triesStepInfo');
        if (!info) return;
        info.style.display = 'block';
        const desc = document.getElementById('triesStepDescription');
        if (!desc) return;
...
window.TriesController = TriesController;
